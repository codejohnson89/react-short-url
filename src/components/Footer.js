        ...
        <>
            <Container className="footer">
                <Row>
                    ...
                    <Col md={6} sm={12} className="row list-links">
                        <Col md={4} sm={12}>
                            <h5>Features</h5>
                            <ul>
                    ...
                    <Col md={2} sm={12} className="social-container">
                        <img src={facebook} alt="social" width="24" height="24" />
                        <img src={instagram} alt="social" width="24" height="24" />
                        <img src={twitter} alt="social" width="24" height="24" />
                        <img src={pinterest} alt="social" width="24" height="24" />
                    </Col>
                </Row>
            </Container>
        </>
